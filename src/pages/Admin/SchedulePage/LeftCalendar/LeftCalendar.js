...
const LeftCalendar = ({ currentDate, setCurrentDate, calendarRef }) => {
    return (
        <div className="flex flex-col border px-1 pb-2">
            <Calendar
                fullscreen={false}
                mode="month"
                value={currentDate}
            ...
            />
            <div className="mt-2 text-sm max-lg:flex max-lg:items-center max-lg:justify-center max-lg:gap-10">
                <div className="block max-lg:flex max-lg:items-center">
